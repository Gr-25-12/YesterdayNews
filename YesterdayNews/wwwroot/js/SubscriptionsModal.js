...
////                                    </div>
////                                    </div>
////                                    <form method="post" asp-action="SubscribeNow" asp-controller="Subscription" id="subscriptionForm" class="w-100">
////                                     <input type="hidden" name="planId" value="${plan.id}" />
////                                    <div class="mt-auto">
////                                        <button type="submit" class="btn btn-lg w-100 rounded-pill fw-bold py-3 choose-plan-btn transition-all"
...
////    if (e.target && e.target.matches('form[id^="subscriptionForm"]')) {
////        e.preventDefault();
...
//            const forms = container.querySelectorAll('.subscription-form');
//            forms.forEach(form => {
